 ...
 * 
 * Returns transaction-level earnings data for all creators
 * Ideal for Power BI time-series analysis and detailed reporting
 * 
 * Query Parameters:
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`=== POWER BI EARNINGS DETAIL REQUEST ===`);
